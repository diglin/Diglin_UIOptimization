 ...
 */
class Diglin_Minify_Controller_Page extends Diglin_Minify_Controller_Base {
    ...
    public function setupSources($options) {
        ...
        if (isset($options['minifyAll'])) {
            ...
            $sourceSpec['minifyOptions'] = array(
                'cssMinifier' => array('Diglin_Minify_CSS', 'minify')
                ,'jsMinifier' => array('Diglin_JSMin', 'minify')
            );
            $this->_loadCssJsMinifiers = true;
            unset($options['minifyAll']);
        }
        $this->sources[] = new Diglin_Minify_Source($sourceSpec);
        
        $options['contentType'] = Diglin_Minify::TYPE_HTML;
        return $options;
    }
