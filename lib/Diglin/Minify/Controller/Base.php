 ...
 */
abstract class Diglin_Minify_Controller_Base {
    ...
    public function getDefaultMinifers() {
        $ret[Diglin_Minify::TYPE_JS] = array('Diglin_JSMin', 'minify');
        $ret[Diglin_Minify::TYPE_CSS] = array('Diglin_Minify_CSS', 'minify');
        $ret[Diglin_Minify::TYPE_HTML] = array('Diglin_Minify_HTML', 'minify');
        return $ret;
    }
