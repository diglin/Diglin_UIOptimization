...
/**
 * require the Diglin_HTTP_Request2 class for sending requests to the validator.
 */
 ...
 * @link     http://pear.php.net/package/Diglin_Services_W3C_HTMLValidator
 */
class Diglin_Services_W3C_HTMLValidator
{
    /**
    ...
    function __construct($options = array())
    {
        ...
        $this->setRequest(new Diglin_HTTP_Request2());
    }
     ...
     *
     * @param Diglin_HTTP_Request2 $request The request object.
     * 
     * @return Diglin_Services_W3C_HTMLValidator
     */
    function setRequest(Diglin_HTTP_Request2 $request)
    {
     ...
     * 
     * @return mixed object Diglin_Services_W3C_HTMLValidator | bool false
     */
     ...
     * 
     * @return mixed object Diglin_Services_W3C_HTMLValidator | bool fals
     */
     ...
     *
     * @throws Diglin_Services_W3C_HTMLValidator_Exception
     * 
    ...
    protected function sendRequest()
    {
        try {
            ...
            if (version_compare(phpversion(), '5.3.0', '>')) {
                throw new Diglin_Services_W3C_HTMLValidator_Exception('Error sending request to the validator', $e);
            }
            // Rethrow
            throw $e;
        }
     ...
     * 
     * @return mixed object Diglin_Services_W3C_HTMLValidator_Response | bool false
     */
    static function parseSOAP12Response($xml)
    {
        $doc = new DOMDocument();
        if ($doc->loadXML($xml)) {
            $response = new Diglin_Services_W3C_HTMLValidator_Response();
            ...
            if (!$response->validity) {
                ...
                foreach ($errors as $error) {
                    $response->errors[] =
                        new Diglin_Services_W3C_HTMLValidator_Error($error);
                }
            }
            $warnings = $doc->getElementsByTagName('warning');
            foreach ($warnings as $warning) {
                $response->warnings[] =
                    new Diglin_Services_W3C_HTMLValidator_Warning($warning);
            }
            return $response;
        } else {
