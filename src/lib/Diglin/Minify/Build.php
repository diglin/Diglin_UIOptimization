 ...
 * $jsBuild = new Diglin_Minify_Build($groupSources['js']);
 * $cssBuild = new Diglin_Minify_Build($groupSources['css']);
 * 
...
class Diglin_Minify_Build {
    ...
    public function __construct($sources) 
    {
        ...
        foreach ((array)$sources as $source) {
            if ($source instanceof Diglin_Minify_Source) {
