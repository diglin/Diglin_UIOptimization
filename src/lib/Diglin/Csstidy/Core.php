 ...
 * @version 1.3
 */
require_once 'Diglin/Csstidy/data.inc.php';
...
class Diglin_Csstidy_Core
{
    ...
    public function __construct()
    {
        ...
        $this->print = new Diglin_Csstidy_Print($this);
        $this->optimise = new Diglin_Csstidy_Optimise($this);
    }
     ...
     * @version 1.0
     */
    public function add_token($type, $data, $do = false) {
    ...
    {
    	$tokens =& $GLOBALS['csstidy']['tokens'];
    	return (strpos($tokens, $string{$i}) !== false && !self::escaped($string,$i));
    }
